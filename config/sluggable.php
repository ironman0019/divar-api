...
return [
     ...
     *
     * Set this to a callable class method so config caching works with
     * `php artisan optimize` / `config:cache` (Closures are not serializable).
     *
     *    'method' => [App\Support\Slugger::class, 'make'],
     */
