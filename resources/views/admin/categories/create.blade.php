...
<main class="p-4 lg:p-6">
    ...
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6">
        <div>
            <h1 class="text-yellow-primary font-bold text-xl lg:text-2xl mb-2">افزودن دسته‌بندی جدید</h1>
            <p class="text-gray-400 text-sm lg:text-base">ایجاد دسته‌بندی جدید برای سایت</p>
        </div>
    ...
    <div class="bg-dark-secondary rounded-xl border border-yellow-primary/20 p-6">
        <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <!-- Icon Upload -->
                <div>
                    <label for="icon" class="block text-gray-300 font-medium mb-2">آیکون دسته‌بندی</label>
                    <div class="relative">
                        <input type="file" 
                               id="icon" 
                               name="icon" 
