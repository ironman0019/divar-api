...
@section('content')
<!-- Create Category Attribute Content -->
<main class="p-4 lg:p-6">
    <!-- Header -->
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6">
        <div>
            <h1 class="text-yellow-primary font-bold text-xl lg:text-2xl mb-2">افزودن ویژگی جدید</h1>
            <p class="text-gray-400 text-sm lg:text-base">ایجاد ویژگی جدید برای دسته‌بندی</p>
        </div>
    ...
    <div class="bg-dark-secondary rounded-xl border border-yellow-primary/20 p-6">
        <form action="{{ route('admin.categories.attributes.store') }}" method="POST">
            @csrf
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="type" 
                        ...
                        <option value="0" {{ old('type') == '0' ? 'selected' : '' }}>متن</option>
