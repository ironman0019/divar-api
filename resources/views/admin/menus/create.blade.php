...
<main class="p-4 lg:p-6">
    ...
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6">
        <div>
            <h1 class="text-yellow-primary font-bold text-xl lg:text-2xl mb-2">افزودن منو جدید</h1>
            <p class="text-gray-400 text-sm lg:text-base">ایجاد منو جدید برای سایت</p>
        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="position" 
                        ...
                        <option value="sidebar" {{ old('position') == 'sidebar' ? 'selected' : '' }}>نوار کناری</option>
                ...
                <!-- Icon Upload -->
                <div>
                    <label for="icon" class="block text-gray-300 font-medium mb-2">آیکون منو</label>
                    <div class="relative">
                        <input type="file" 
                               id="icon" 
                               name="icon" 
